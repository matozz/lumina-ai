          ...
          {cue.layers.map((layer, index) => {
            ...
            return (
              ...
              >
                ...
                <Field>
                  <FieldLabel htmlFor={`${layer.id}-speed-override`}>Speed override</FieldLabel>
                  <Input
                    ...
                    max={8}
                    step={0.125}
                    defaultValue={speedOverrideValue}
                    placeholder="Use Effect default"
                    onBlur={(event) => {
                      const value = event.currentTarget.value.trim();
                      const parameterOverrides = { ...(layer.parameter_overrides ?? {}) };
                      if (!value) delete parameterOverrides.speed;
