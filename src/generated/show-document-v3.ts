...
export type TimelineActionV3DSL =
  | {
      instance_id: string;
      type: "effect";
    }
...
export interface TimelineEventV3DSL {
  action: TimelineActionV3DSL;
  beat: number;
  duration?: number | null;
}

export interface TimelineV3DSL {
  events: Array<TimelineEventV3DSL>;
}

export interface ShowDocumentV3 {
