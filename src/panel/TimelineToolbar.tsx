...
export function TimelineToolbar({ globalBeat }: ToolbarProps) {
  return (
    <div className={cn(
      "h-9 border-b border-zinc-800 bg-zinc-900/80 flex items-center px-4 justify-between backdrop-blur-md"
    )}>
      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2 bg-zinc-950/50 px-3 py-1 rounded-md border border-zinc-800 shadow-inner">
          <div className="w-1.5 h-1.5 rounded-full bg-red-500 animate-pulse" />
          <span className="text-[11px] text-zinc-400 font-mono tracking-wider">BEAT</span>
          <span className="text-[13px] text-zinc-100 font-mono font-medium">
