  ...
  return (
    <div
      ...
      onKeyDown={(keyboardEvent) => {
        if (keyboardEvent.key === "Delete" || keyboardEvent.key === "Backspace") {
          ...
          actions.onNudge(event.originalIndex, direction * (keyboardEvent.shiftKey ? 4 : 0.5));
        }
      }}
    ...
    >
      <div className="pointer-events-none flex w-full items-center justify-between overflow-hidden px-1">
        <span className="truncate text-[11px] font-medium text-white drop-shadow-md">{label}</span>
      </div>
