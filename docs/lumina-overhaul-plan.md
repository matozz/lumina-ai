...
- [x] 对 UI 的修改包含状态机、回归和真实窗口验证（Draft Preview、Published Rehearsal、Live isolation；最大化、1440×900、1100×720；完整无 Raw DSL 路径）。
